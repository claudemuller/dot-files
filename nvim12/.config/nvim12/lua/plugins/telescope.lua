...
vim.pack.add({
	...
	{
		src = 'http://github.com/nvim-telescope/telescope-fzf-native.nvim',
		build = function()
			vim.fn.system('make')
		end,
		cond = function()
...
-- telescope
vim.keymap.set('n', '<leader>t', builtin.builtin, { desc = 'Telescope selects' })

-- search word under cursor
vim.keymap.set('n', '<leader>w', builtin.grep_string, { desc = 'Word under cursor in buffer' })
...
-- TODO: combine this and the prvious one
...
vim.keymap.set('n', '<leader>vl', builtin.git_commits, { desc = 'Show commits log (Telescope)' })
vim.keymap.set('n', '<leader>v.', builtin.git_bcommits, { desc = 'Show commits log for buffer (Telescope)' })
