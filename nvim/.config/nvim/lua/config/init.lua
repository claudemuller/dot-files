...
-- Change the hover-mulitword selection colour
vim.api.nvim_set_hl(0, "LspReferenceText", { underline = false, bg = "#e5e5e5" })
vim.api.nvim_set_hl(0, "LspReferenceRead", { underline = false, bg = "#e5e5e5" })
vim.api.nvim_set_hl(0, "LspReferenceWrite", { underline = false, bg = "#e5e5e5" })
vim.api.nvim_set_hl(0, "IlluminatedWordText", { underline = false, bg = "#e5e5e5" })
vim.api.nvim_set_hl(0, "IlluminatedWordRead", { underline = false, bg = "#e5e5e5" })
vim.api.nvim_set_hl(0, "IlluminatedWordWrite", { underline = false, bg = "#e5e5e5" })
